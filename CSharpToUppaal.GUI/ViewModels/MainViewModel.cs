...
namespace CSharpToUppaal.GUI.ViewModels
{
    public partial class MainViewModel : ObservableObject
    {
        ...
        private CSharpToUppaal.Backend.Models.Project _currentProject;
        ...
        [ObservableProperty]
        private string _currentProject = "No project loaded";
...
namespace Example
{
    public class Calculator
    {
        ...
        {
            // Commands are automatically generated by [RelayCommand] attributes
        }
        ...
        private async void LoadSampleProject()
        {
            try
            {
                ...
                _currentProject = await _engine.CreateProjectAsync("Sample Project", "Demo project with sample code");
                CurrentProject = _currentProject.Name;

                var sourceFile = await _engine.AddSourceCodeAsync(_currentProject, SourceCode, "Sample.cs");
        ...
        private async Task NewProject()
        {
            try
            {
                ...
                if (dialog.ShowDialog() == true)
                {
                    ...
                    _currentProject = await _engine.CreateProjectAsync(dialog.Result);
                    CurrentProject = _currentProject.Name;
        ...
        private async Task OpenFile()
        {
            try
            {
                ...
                if (openFileDialog.ShowDialog() == true)
                {
                    ...
                    {
                        _currentProject = await _engine.CreateProjectAsync(
                            Path.GetFileNameWithoutExtension(openFileDialog.FileName));
                        CurrentProject = _currentProject.Name;
                    }

                    var sourceFile = await _engine.AddSourceFileAsync(_currentProject, openFileDialog.FileName);
        ...
        private async Task ParseCode()
        {
            try
            {
                ...
                if (_currentProject == null)
                {
                    _currentProject = await _engine.CreateProjectAsync("Parsed Project");
                    CurrentProject = _currentProject.Name;
                }

                var sourceFile = await _engine.AddSourceCodeAsync(_currentProject, SourceCode, "Source.cs");
        ...
        private async Task AnalyzeCode()
        {
            try
            {
                ...
                // This would trigger UI updates through property bindings
        ...
        private async Task GenerateCfg()
        {
            try
            {
                ...
                // Here you would typically render the CFG visualization
        ...
        private async Task GenerateModel()
        {
            try
            {
                if (_currentProject == null || !_currentProject.SourceFiles.Any())
                {
                ...
                var model = await _engine.GenerateModelAsync(_currentProject, ModelName);
        ...
        private void ClearAll()
        {
            ...
            if (result == MessageBoxResult.Yes)
            {
                ...
                CurrentProject = "No project loaded";
                SourceCode = "";
                Methods.Clear();
                UppaalXml = "<!-- UPPAAL model will be generated here -->";
                VerificationResults.Clear();
        ...
        private void ShowCfg()
        {
            ...
            StatusMessage = "Showing CFG visualization";
        }

        [RelayCommand]
        private void ShowModel()
        {
            StatusMessage = "Showing UPPAAL model";
        }

        [RelayCommand]
        private void ShowVerification()
        {
            StatusMessage = "Showing verification results";
        }
